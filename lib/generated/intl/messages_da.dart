...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Ændrede valuta til ${currency}";

  static String m4(day) => "${day} dage siden";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Slutter om ${timeLeft}";

  static String m7(captcha) => "Indtast ${captcha} for at bekræfte:";

  static String m8(message) => "Fejl: ${message}";

  static String m9(time) => "Udløber om ${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => " for${hour} timer siden";
  ...
  static String m13(size) => "Maksimal filstørrelse: ${size} MB";

  static String m14(minute) => " for${minute} minutter siden";

  static String m15(month) => " for${month} måneder siden";

  static String m16(store) => "Mere fra ${store}";

  static String m17(itemCount) => "${itemCount} elementer";

  static String m18(price) => "Indstillinger i alt: ${price}";

  static String m19(total) => "Antal: ${total}";

  static String m20(percent) => "Udsalg ${percent}%";

  static String m21(second) => " for${second} sekunder siden";

  static String m22(totalCartQuantity) =>
      "Indkøbskurv, ${totalCartQuantity} varer";

  static String m23(numberOfUnitsSold) => "Solgt: ${numberOfUnitsSold}";

  static String m24(fieldName) => "Feltet ${fieldName} er påkrævet";

  static String m25(total) => "${total} produkter";

  static String m26(date) => "Gyldig til ${date}";

  static String m27(message) => "Advarsel: ${message}";
  ...
  static String m29(length) => "Vi fandt ${length} produkter";

  static String m30(week) => "Uge ${week}";

  static String m31(year) => " for${year} år siden";

  static String m32(total) => "Du har tildelt ordrenummer${total}";
