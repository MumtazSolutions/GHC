...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Devise changée en ${currency}";

  static String m4(day) => "il y a ${day} jours";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Se termine dans ${timeLeft}";

  static String m7(captcha) => "Saisissez ${captcha} pour confirmer :";

  static String m8(message) => "Erreur: ${message}";

  static String m9(time) => "Expirant dans ${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => "il y a ${hour} heures";
  ...
  static String m13(size) => "Taille maximale du fichier: ${size} Mo";

  static String m14(minute) => "il y a ${minute} minutes";

  static String m15(month) => " Il y a${month} mois";

  static String m16(store) => "Plus de ${store}";

  static String m17(itemCount) => "${itemCount} produits";

  static String m18(price) => "Total des options: ${price}";

  static String m19(total) => "Qté: ${total}";

  static String m20(percent) => "Remise ${percent} %";

  static String m21(second) => "il y a ${second} secondes";

  static String m22(totalCartQuantity) =>
      "Panier, ${totalCartQuantity} produits";

  static String m23(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m24(fieldName) => "Le champ ${fieldName} est obligatoire";

  static String m25(total) => "${total} Produits";

  static String m26(date) => "Valable jusqu\'au ${date}";

  static String m27(message) => "Avertissement: ${message}";
  ...
  static String m29(length) => "Nous avons trouvé des ${length} produits";

  static String m30(week) => "Semaine ${week}";

  static String m31(year) => " Il y a${year} ans";

  static String m32(total) => "Vous avez affecté à la commande n°${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "chooseType": MessageLookupByLibrary.simpleMessage("Choisissez le type"),
    ...
    "historyTransaction": MessageLookupByLibrary.simpleMessage("L\'histoire"),
    ...
    "storeEmail": MessageLookupByLibrary.simpleMessage("Email de la boutique"),
