...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Para birimi ${currency}olarak değiştirildi";

  static String m4(day) => "${day} Gün önce";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Ends in ${timeLeft}";

  static String m7(captcha) => "Onaylamak için ${captcha} girin:";

  static String m8(message) => "Hata: ${message}";

  static String m9(time) => " ${time}içinde süresi doluyor";

  static String m10(total) => ">${total} km";

  static String m11(hour) => "${hour} Saat önce";
  ...
  static String m13(size) => "Maksimum dosya boyutu: ${size} MB";

  static String m14(minute) => "${minute} Dakika önce";

  static String m15(month) => "${month} ay önce";

  static String m16(store) => " ${store}\'dan daha fazlası";

  static String m17(itemCount) => "${itemCount} ürün";

  static String m18(price) => "Toplam seçenek: ${price}";

  static String m19(total) => "Adet: ${total}";

  static String m20(percent) => "% ${percent} İndirim ";

  static String m21(second) => "${second} Saniye önce";

  static String m22(totalCartQuantity) => "${totalCartQuantity} ürün, Sepette";

  static String m23(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m24(fieldName) => " ${fieldName} alanı zorunludur";

  static String m25(total) => "${total} ürün";

  static String m26(date) => " ${date}tarihine kadar geçerlidir";

  static String m27(message) => "Hata: ${message}";
  ...
  static String m29(length) => " \$${length} Ürün Bulundu";

  static String m30(week) => " ${week}haftası";

  static String m31(year) => "${year} yıl önce";

  static String m32(total) => "#${total}numaralı siparişe atadınız";
