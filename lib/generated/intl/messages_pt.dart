...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Moeda alterada para ${currency}";

  static String m4(day) => "${day} dias atrás";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Ends in ${timeLeft}";

  static String m7(captcha) => "Digite ${captcha} para confirmar:";

  static String m8(message) => "Erro: ${message}";

  static String m9(time) => "Expirando em ${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => "${hour} horas atrás";
  ...
  static String m13(size) => "Tamanho máximo do arquivo: ${size} MB";

  static String m14(minute) => "${minute} minutos atrás";

  static String m15(month) => "${month} meses atrás";

  static String m16(store) => "Mais de ${store}";

  static String m17(itemCount) => "${itemCount} itens";

  static String m18(price) => "Opções totais: ${price}";

  static String m19(total) => "Qtd: ${total}";

  static String m20(percent) => "Desconto ${percent} %";

  static String m21(second) => "${second} segundos atrás";
  ...
  static String m25(total) => "${total} produtos";

  static String m26(date) => "Válido até ${date}";

  static String m27(message) => "Atenção: ${message}";
  ...
  static String m29(length) => "Encontramos ${length} produtos";

  static String m30(week) => "Semana ${week}";

  static String m31(year) => "${year} anos atrás";

  static String m32(total) => "Você atribuiu o pedido nº${total}";
