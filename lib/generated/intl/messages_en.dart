...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Changed currency to ${currency}";
  ...
  static String m7(captcha) => "Enter ${captcha} to confirm:";
  ...
  static String m13(size) => "Maximum file size: ${size} MB";

  static String m14(minute) => "${minute} minutes ago";

  static String m15(month) => "${month} months ago";

  static String m16(store) => "More from ${store}";
  ...
  static String m31(year) => "${year} years ago";
