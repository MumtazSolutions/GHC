...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Ndryshoi monedhën në ${currency}";

  static String m4(day) => "${day} ditë më parë";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Përfundon në ${timeLeft}";

  static String m7(captcha) => "Futni ${captcha} për të konfirmuar:";

  static String m8(message) => "Gabim: ${message}";

  static String m9(time) => "Skadon në ${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => "${hour} orë më parë";
  ...
  static String m13(size) => "Madhësia maksimale e skedarit: ${size} MB";

  static String m14(minute) => "${minute} minuta më parë";

  static String m15(month) => "${month} muaj më parë";

  static String m16(store) => "Më shumë nga ${store}";

  static String m17(itemCount) => "${itemCount} artikuj";

  static String m18(price) => "Opsionet totale: ${price}";

  static String m19(total) => "Sasia: ${total}";

  static String m20(percent) => "Shitje ${percent}%";

  static String m21(second) => "${second} sekonda më parë";

  static String m22(totalCartQuantity) =>
      "Shporta e blerjeve, ${totalCartQuantity} artikuj";

  static String m23(numberOfUnitsSold) => "Shitur: ${numberOfUnitsSold}";

  static String m24(fieldName) => "Fusha ${fieldName} kërkohet";

  static String m25(total) => "${total} produkte";

  static String m26(date) => "E vlefshme deri më ${date}";

  static String m27(message) => "Paralajmërim: ${message}";
  ...
  static String m29(length) => "Ne gjetëm ${length} produkte";

  static String m30(week) => "Java ${week}";

  static String m31(year) => "${year} vjet më parë";

  static String m32(total) => "Ju keni caktuar porosinë #${total}";
