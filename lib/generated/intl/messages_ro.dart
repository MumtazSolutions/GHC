...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "S-a schimbat moneda în ${currency}";

  static String m4(day) => "${day} zile în urmă";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Se termină în ${timeLeft}";

  static String m7(captcha) => "Introdu ${captcha} pentru a confirma:";

  static String m8(message) => "Eroare: ${message}";

  static String m9(time) => "Expiră în ${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => "${hour} ore în urmă";
  ...
  static String m13(size) => "Dimensiunea maximă a fișierului: ${size} MB";

  static String m14(minute) => "${minute} minute în urmă";

  static String m15(month) => " Acum${month} luni";

  static String m16(store) => "Mai multe de la ${store}";

  static String m17(itemCount) => "${itemCount} articole";

  static String m18(price) => "Opțiuni totale: ${price}";

  static String m19(total) => "Cantitate: ${total}";

  static String m20(percent) => "Reducere ${percent} %";

  static String m21(second) => "${second} secunde în urmă";

  static String m22(totalCartQuantity) =>
      "Coș de cumpărături, ${totalCartQuantity} articole";

  static String m23(numberOfUnitsSold) => "Vândut: ${numberOfUnitsSold}";

  static String m24(fieldName) => "Câmpul ${fieldName} este obligatoriu";

  static String m25(total) => "${total} articole";

  static String m26(date) => "Valabil până la ${date}";

  static String m27(message) => "Atenție: ${message}";
  ...
  static String m29(length) => "Am găsit ${length} articole";

  static String m30(week) => "Săptămâna ${week}";

  static String m31(year) => " Acum${year} ani";

  static String m32(total) => "Ați atribuit comenzii nr.${total}";
