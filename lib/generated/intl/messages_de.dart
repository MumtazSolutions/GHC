...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Währung auf ${currency}geändert";

  static String m4(day) => "Vor ${day} Tagen";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Endet in ${timeLeft}";

  static String m7(captcha) => "Geben Sie ${captcha} ein, um zu bestätigen:";

  static String m8(message) => "Fehler: ${message}";

  static String m9(time) => "Ablaufen in ${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => "Vor ${hour} Stunden";
  ...
  static String m13(size) => "Maximale Dateigröße: ${size} MB";

  static String m14(minute) => "Vor ${minute} Minuten";

  static String m15(month) => " Vor${month} Monaten";

  static String m16(store) => "Mehr von ${store}";

  static String m17(itemCount) => "${itemCount} Artikel";

  static String m18(price) => "Optionen insgesamt: ${price}";

  static String m19(total) => "Menge: ${total}";

  static String m20(percent) => "Ausverkauf ${percent} %";

  static String m21(second) => "Vor ${second} Sekunden";

  static String m22(totalCartQuantity) =>
      "Warenkorb, ${totalCartQuantity} Artikel";

  static String m23(numberOfUnitsSold) => "Verkauft: ${numberOfUnitsSold}";

  static String m24(fieldName) => "Das Feld ${fieldName} ist erforderlich";

  static String m25(total) => "${total} Produkte";

  static String m26(date) => "Gültig bis ${date}";

  static String m27(message) => "Warnung: ${message}";
  ...
  static String m29(length) => "Wir haben die Produkte gefunden";

  static String m30(week) => "Woche ${week}";

  static String m31(year) => " Vor${year} Jahren";

  static String m32(total) => "Sie haben der Bestellung #${total}zugewiesen";
