...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(attribute) => "کوئی بھی ${attribute}";

  static String m1(point) => "آپ کے دستیاب پوائنٹس: ${point}";

  static String m2(state) => "بلوٹوتھ اڈاپٹر ہے ${state}";

  static String m3(currency) => "کرنسی کو ${currency}میں تبدیل کر دیا گیا";

  static String m4(day) => "${day} دن پہلے";

  static String m5(total) => "~${total} کلومیٹر";

  static String m6(timeLeft) => " ${timeLeft}میں ختم ہوتا ہے";

  static String m7(captcha) => "تصدیق کرنے کے لیے ${captcha} درج کریں:";

  static String m8(message) => "خرابی: ${message}";

  static String m9(time) => " ${time}میں میعاد ختم ہو رہی ہے";

  static String m10(total) => ">${total} کلومیٹر";

  static String m11(hour) => "${hour} گھنٹے پہلے";
  ...
  static String m13(size) => "فائل کا زیادہ سے زیادہ سائز: ${size} MB";

  static String m14(minute) => "${minute} منٹ پہلے";

  static String m15(month) => "${month} مہینے پہلے";

  static String m16(store) => " ${store}سے مزید";

  static String m17(itemCount) => "${itemCount} آئٹمز";

  static String m18(price) => "کل اختیارات: ${price}";

  static String m19(total) => "مقدار: ${total}";

  static String m20(percent) => "فروخت ${percent}%";

  static String m21(second) => "${second} سیکنڈ پہلے";

  static String m22(totalCartQuantity) =>
      "شاپنگ کارٹ، ${totalCartQuantity} آئٹمز";

  static String m23(numberOfUnitsSold) => "فروخت کیا گیا: ${numberOfUnitsSold}";

  static String m24(fieldName) => " ${fieldName} فیلڈ درکار ہے۔";

  static String m25(total) => "${total} مصنوعات";

  static String m26(date) => " ${date}تک درست";

  static String m27(message) => "انتباہ: ${message}";
  ...
  static String m29(length) => "ہمیں ${length} پروڈکٹس ملے";

  static String m30(week) => "ہفتہ ${week}";

  static String m31(year) => "${year} سال پہلے";

  static String m32(total) => "آپ نے آرڈر #${total}کو تفویض کیا ہے";
