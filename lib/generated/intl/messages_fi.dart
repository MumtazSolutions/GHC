...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Valuutta muutettu arvoon ${currency}";

  static String m4(day) => "${day} päivää sitten";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Päättyy ${timeLeft}";

  static String m7(captcha) => "Vahvista kirjoittamalla ${captcha} :";

  static String m8(message) => "Virhe: ${message}";

  static String m9(time) => "Vanhenee ${time}kuluttua";

  static String m10(total) => ">${total} km";

  static String m11(hour) => "${hour} tuntia sitten";
  ...
  static String m13(size) => "Tiedoston enimmäiskoko: ${size} Mt";

  static String m14(minute) => "${minute} minuuttia sitten";

  static String m15(month) => "${month} kuukautta sitten";

  static String m16(store) => "Lisää käyttäjältä ${store}";

  static String m17(itemCount) => "${itemCount} kohdetta";

  static String m18(price) => "Vaihtoehdot yhteensä: ${price}";

  static String m19(total) => "Määrä: ${total}";

  static String m20(percent) => "Alennus ${percent}%";

  static String m21(second) => "${second} sekuntia sitten";

  static String m22(totalCartQuantity) =>
      "Ostoskori, ${totalCartQuantity} tuotetta";

  static String m23(numberOfUnitsSold) => "Myyty: ${numberOfUnitsSold}";

  static String m24(fieldName) => "Kenttä ${fieldName} on pakollinen";

  static String m25(total) => "${total} tuotetta";

  static String m26(date) => "Voimassa ${date}asti";

  static String m27(message) => "Varoitus: ${message}";
  ...
  static String m29(length) => "Löysimme ${length} tuotetta";

  static String m30(week) => "Viikko ${week}";

  static String m31(year) => "${year} vuotta sitten";

  static String m32(total) => "Olet määrittänyt tilauksen #${total}";
