...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "ປ່ຽນສະກຸນເງິນເປັນ ${currency}";

  static String m4(day) => "${day} ມື້ກ່ອນ";

  static String m5(total) => "~${total} ກິໂລແມັດ";

  static String m6(timeLeft) => "ສິ້ນສຸດໃນ ${timeLeft}";

  static String m7(captcha) => "ໃສ່ ${captcha} ເພື່ອຢືນຢັນ:";

  static String m8(message) => "ເກີດຂໍ້ຜິດພາດ: ${message}";

  static String m9(time) => "ໝົດອາຍຸໃນ ${time}";

  static String m10(total) => ">${total} ກິໂລແມັດ";

  static String m11(hour) => "${hour} ຊົ່ວໂມງກ່ອນ";

  static String m12(message) =>
      "ມີບັນຫາກັບແອັບຯໃນລະຫວ່າງການຮ້ອງຂໍຂໍ້ມູນ, ກະລຸນາຕິດຕໍ່ຜູ້ເບິ່ງແຍງເພື່ອແກ້ໄຂບັນຫາ: ${message}";

  static String m13(size) => "ຂະໜາດໄຟລ໌ສູງສຸດ: ${size} MB";

  static String m14(minute) => "${minute} ນາທີກ່ອນ";

  static String m15(month) => "${month} ເດືອນກ່ອນ";

  static String m16(store) => "ເພີ່ມເຕີມຈາກ ${store}";

  static String m17(itemCount) => "${itemCount} ລາຍການ";

  static String m18(price) => "ຕົວເລືອກທັງໝົດ: ${price}";

  static String m19(total) => "ຈຳນວນ: ${total}";

  static String m20(percent) => "ຂາຍ ${percent}%";

  static String m21(second) => "${second} ວິນາທີກ່ອນ";

  static String m22(totalCartQuantity) =>
      "ກະຕ່າເຄື່ອງ, ${totalCartQuantity} ລາຍການ";

  static String m23(numberOfUnitsSold) => "ຂາຍແລ້ວ: ${numberOfUnitsSold}";

  static String m24(fieldName) => "ຕ້ອງມີຊ່ອງຂໍ້ມູນ ${fieldName} ";

  static String m25(total) => "${total} ຜະລິດຕະພັນ";

  static String m26(date) => "ໃຊ້ໄດ້ຈົນຮອດ ${date}";

  static String m27(message) => "ຄຳເຕືອນ: ${message}";

  static String m28(default_currency) =>
      "ສະກຸນເງິນທີ່ເລືອກໃນປັດຈຸບັນບໍ່ສາມາດໃຊ້ໄດ້ກັບ Wallet, ກະລຸນາປ່ຽນເປັນ ${default_currency}";

  static String m29(length) => "ພວກເຮົາພົບເຫັນ ${length} ຜະລິດຕະພັນ";

  static String m30(week) => "ອາທິດ ${week}";

  static String m31(year) => "${year} ປີກ່ອນ";

  static String m32(total) => "ທ່ານໄດ້ມອບໝາຍໃຫ້ສັ່ງ #${total}";
