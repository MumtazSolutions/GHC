...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Zmieniono walutę na ${currency}";

  static String m4(day) => "${day} dni temu";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Kończy się za ${timeLeft}";

  static String m7(captcha) => "Wpisz ${captcha} , aby potwierdzić:";

  static String m8(message) => "Błąd: ${message}";

  static String m9(time) => "Wygasa za ${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => "${hour} godz. Temu";
  ...
  static String m13(size) => "Maksymalny rozmiar pliku: ${size} MB";

  static String m14(minute) => "${minute} min temu";

  static String m15(month) => "${month} miesięcy temu";

  static String m16(store) => "Więcej od ${store}";

  static String m17(itemCount) => "${itemCount} elementów";

  static String m18(price) => "Łącznie opcje: ${price}";

  static String m19(total) => "Ilość: ${total}";

  static String m20(percent) => "Wyprzedaż ${percent}%";

  static String m21(second) => "${second} sekundy temu";

  static String m22(totalCartQuantity) =>
      "Koszyk, ${totalCartQuantity} pozycje";

  static String m23(numberOfUnitsSold) => "Sprzedane: ${numberOfUnitsSold}";

  static String m24(fieldName) => "Pole ${fieldName} jest wymagane";

  static String m25(total) => "${total} produktów";

  static String m26(date) => "Ważne do ${date}";

  static String m27(message) => "Ostrzeżenie: ${message}";
  ...
  static String m29(length) => "Znaleźliśmy ${length} produktów";

  static String m30(week) => "Tydzień ${week}";

  static String m31(year) => "${year} lat temu";

  static String m32(total) => "Przypisałeś do zamówienia nr${total}";
