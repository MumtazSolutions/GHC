...
class _StateUserUpdate extends BaseScreen<UserUpdateScreen> {
  ...
  FocusNode? userDisplayNameFn=FocusNode();
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                const SizedBox(height: 8),
                                TextFormField(
                                  focusNode: userDisplayNameFn,
                                  decoration:  InputDecoration(
                                    fillColor: userDisplayNameFn?.hasFocus==true?Colors.transparent:Colors.grey.withOpacity(.20),
                                    filled: true,
                                    enabledBorder: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(10),
                                        borderSide: BorderSide(color:
                                        Colors.grey.withOpacity(.20),width: 2,)
                                    ),
                                ...
                                if (!user.isSocial!)
                                  Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      TextField(
                                        obscureText: true,
                                        focusNode: userPasswordFn,
                                        decoration:  InputDecoration(
                                          fillColor: userPasswordFn?.hasFocus==true?Colors.transparent:Colors.grey.withOpacity(.20),
                                          filled: true,
                                          enabledBorder: OutlineInputBorder(
                                              borderRadius: BorderRadius.circular(10),
                                              borderSide: BorderSide(color:
