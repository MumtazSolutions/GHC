...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Valyuta ${currency}ga almashtirildi";

  static String m4(day) => "${day} kun oldin";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => " ${timeLeft}da tugaydi";

  static String m7(captcha) => "Tasdiqlash uchun ${captcha} kiriting:";

  static String m8(message) => "Xato: ${message}";

  static String m9(time) => "Muddati: ${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => "${hour} soat oldin";
  ...
  static String m13(size) => "Maksimal fayl hajmi: ${size} MB";

  static String m14(minute) => "${minute} daqiqa oldin";

  static String m15(month) => "${month} oy oldin";

  static String m16(store) => "Yana ${store}";

  static String m17(itemCount) => "${itemCount} ta element";

  static String m18(price) => "Jami variantlar: ${price}";

  static String m19(total) => "Miqdor: ${total}";

  static String m20(percent) => "Sotish: ${percent}%";

  static String m21(second) => "${second} soniya oldin";

  static String m22(totalCartQuantity) =>
      "Savat savati, ${totalCartQuantity} ta mahsulot";

  static String m23(numberOfUnitsSold) => "Sotilgan: ${numberOfUnitsSold}";

  static String m24(fieldName) => " ${fieldName} maydoni to\'ldirilishi shart";

  static String m25(total) => "${total} ta mahsulot";

  static String m26(date) => " ${date}gacha amal qiladi";

  static String m27(message) => "Ogohlantirish: ${message}";
  ...
  static String m29(length) => "Biz ${length} ta mahsulotni topdik";

  static String m30(week) => " ${week}hafta";

  static String m31(year) => "${year} yil oldin";

  static String m32(total) => "Siz buyurtma berdingiz:${total}";
