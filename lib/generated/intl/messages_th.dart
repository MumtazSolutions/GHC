...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "เปลี่ยนสกุลเงินเป็น ${currency}";

  static String m4(day) => "${day} วันที่ผ่านมา";

  static String m5(total) => "~${total} กม.";

  static String m6(timeLeft) => "Ends in ${timeLeft}";

  static String m7(captcha) => "ป้อน ${captcha} เพื่อยืนยัน:";

  static String m8(message) => "ข้อผิดพลาด: ${message}";

  static String m9(time) => "จะหมดอายุใน ${time}";

  static String m10(total) => ">${total} กม.";

  static String m11(hour) => "${hour} ชั่วโมงที่ผ่านมา";
  ...
  static String m13(size) => "ขนาดไฟล์สูงสุด: ${size} MB";

  static String m14(minute) => "{นาที} นาทีที่ผ่านมา";

  static String m15(month) => "${month} เดือนที่แล้ว";

  static String m16(store) => "เพิ่มเติมจาก ${store}";

  static String m17(itemCount) => "${itemCount} รายการ";

  static String m18(price) => "ตัวเลือกทั้งหมด: ${price}";

  static String m19(total) => "จำนวน: ${total}";

  static String m20(percent) => "ยอดขาย ${percent} %";

  static String m21(second) => "${second} วินาทีที่ผ่านมา";
  ...
  static String m24(fieldName) => "ต้องระบุช่อง ${fieldName} ";

  static String m25(total) => "${total} สินค้า";

  static String m26(date) => "ใช้ได้จนถึง ${date}";

  static String m27(message) => "คำเตือน: ${message}";
  ...
  static String m29(length) => "เราพบสินค้า ${length}";

  static String m30(week) => "สัปดาห์ ${week}";

  static String m31(year) => "${year} ปีที่แล้ว";

  static String m32(total) => "คุณได้มอบหมายคำสั่งซื้อ #${total}";
