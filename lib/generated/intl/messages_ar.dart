...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "تم تغيير العملة إلى ${currency}";

  static String m4(day) => "منذ: ${day} يوم/أيام";

  static String m5(total) => "~${total} كيلومتر";

  static String m6(timeLeft) => "تنتهي في: ${timeLeft}";

  static String m7(captcha) => "أدخل ${captcha} للتأكيد:";

  static String m8(message) => "حدث خطأ ما: ${message}";

  static String m9(time) => "تنتهي الصلاحية في ${time}";

  static String m10(total) => ">${total} كيلومتر";

  static String m11(hour) => "منذ ${hour} ساعة/ساعات";

  static String m12(message) =>
      "حدثت مشكلة في التطبيق أثناء طلب البيانات ، يرجى الاتصال بالمسؤول لإصلاح المشكلة: ${message}";

  static String m13(size) => "أقصى حجم للملف: ${size} ميغابايت";

  static String m14(minute) => "منذ ${minute} دقيقة/دقائق";

  static String m15(month) => " منذ ${month} شهر/أشهر";

  static String m16(store) => "المزيد من ${store}";

  static String m17(itemCount) => "${itemCount} منتج";

  static String m18(price) => "السعر الإجمالي: ${price}";

  static String m19(total) => "الكمية: ${total}";

  static String m20(percent) => "خصم: ${percent} ٪";

  static String m21(second) => "منذ ${second} ثواني";

  static String m22(totalCartQuantity) =>
      "عدد المنتجات بالسلة: ${totalCartQuantity} منتج";

  static String m23(numberOfUnitsSold) => "عدد المُباع: ${numberOfUnitsSold}";

  static String m24(fieldName) => "الحقل ${fieldName} مطلوب";

  static String m25(total) => "${total} منتج";

  static String m26(date) => "صالح حتى تاريخ: ${date}";

  static String m27(message) => "تحذير: ${message}";

  static String m28(default_currency) =>
      "العملة المحددة حاليًا غير متاحة لميزة المحفظة ، الرجاء تغييرها إلى ${default_currency}";

  static String m29(length) => "وجدنا المنتجات التالية ${length}";

  static String m30(week) => "الإسبوع: ${week}";

  static String m31(year) => " منذ ${year} سنة/سنوات";

  static String m32(total) => "لقد قمت بتعيين الطلب رقم${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "backToWallet": MessageLookupByLibrary.simpleMessage("رجوع إلى المحفظة"),
    ...
    "billingAddress": MessageLookupByLibrary.simpleMessage("عنوان الفاتورة"),
    ...
    "bookingConfirm": MessageLookupByLibrary.simpleMessage("تم تأكيد الحجز"),
    ...
    "continueToShipping": MessageLookupByLibrary.simpleMessage("متابعة للتسوق"),
    ...
    "createAnAccount": MessageLookupByLibrary.simpleMessage("إنشاء حساب جديد"),
    ...
    "createProduct": MessageLookupByLibrary.simpleMessage("إنشاء منتج جديد"),
    ...
    "cvv": MessageLookupByLibrary.simpleMessage("رمز التحقق من البطاقة CVV"),
    ...
    "dashboard": MessageLookupByLibrary.simpleMessage("لوحة التحكم الرئيسية"),
    ...
    "enterYourEmail": MessageLookupByLibrary.simpleMessage("البريد الإلكتروني"),
    ...
    "enterYourPassword": MessageLookupByLibrary.simpleMessage("كلمة المرور"),
    ...
    "getNotified": MessageLookupByLibrary.simpleMessage("الحصول على إخطار!"),
    "getPasswordLink": MessageLookupByLibrary.simpleMessage("نسيت كلمة المرور"),
    ...
    "goBackToReview": MessageLookupByLibrary.simpleMessage("العودة للمراجعة"),
    ...
    "hasBeenDeleted": MessageLookupByLibrary.simpleMessage("تم الحذف بنجاح"),
    ...
    "lightTheme": MessageLookupByLibrary.simpleMessage("موضوع الضوء"),
    ...
    "loginToYourAccount": MessageLookupByLibrary.simpleMessage("تسجيل الدخول"),
    ...
    "noData": MessageLookupByLibrary.simpleMessage("لا توجد معلومات إضافية"),
    ...
    "orderNotes": MessageLookupByLibrary.simpleMessage("الملاحظات على الطلبية"),
    ...
    "orderStatusCompleted": MessageLookupByLibrary.simpleMessage("الطلب مكتمل"),
    "orderStatusDenied": MessageLookupByLibrary.simpleMessage("مرفوضة"),
    "orderStatusExpired": MessageLookupByLibrary.simpleMessage(
      "منتهية الصلاحية",
    ),
    "orderStatusFailed": MessageLookupByLibrary.simpleMessage("الطلبية فشلت"),
    "orderStatusOnHold": MessageLookupByLibrary.simpleMessage("الطلبية معلقة"),
    "orderStatusPending": MessageLookupByLibrary.simpleMessage(
      "الطلبية قيد الإنتظار",
    ),
    ...
    "orderStatusReversed": MessageLookupByLibrary.simpleMessage("تم الإلغاء"),
    ...
    "orderSuccessTitle2": MessageLookupByLibrary.simpleMessage("حسابك الخاص"),
    ...
    "refundRequest": MessageLookupByLibrary.simpleMessage("استعادة الأموال"),
    "refundRequested": MessageLookupByLibrary.simpleMessage(
      "تم طلب استرداد الأموال",
    ),
    ...
    "registerSuccess": MessageLookupByLibrary.simpleMessage("تم تسجيل بنجاح"),
    ...
    "selectThePoint": MessageLookupByLibrary.simpleMessage("الرجاء تحديد نقطة"),
    "selectTheQuantity": MessageLookupByLibrary.simpleMessage("تحديد الكمية"),
    ...
    "titleZToA": MessageLookupByLibrary.simpleMessage("العنوان: من ي إلى أ"),
    ...
    "transactionDetail": MessageLookupByLibrary.simpleMessage("تفاصل المعاملة"),
    "transactionFee": MessageLookupByLibrary.simpleMessage("رسوم التحويل"),
    "transactionResult": MessageLookupByLibrary.simpleMessage("نتائج المعاملة"),
    ...
    "transferSuccess": MessageLookupByLibrary.simpleMessage("تم التحويل بنجاح"),
