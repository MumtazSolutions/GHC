...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Moneda cambiada a ${currency}";

  static String m4(day) => "${day}  días";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Ends in ${timeLeft}";

  static String m7(captcha) => "Introduzca ${captcha} para confirmar:";

  static String m8(message) => "Error: ${message}";

  static String m9(time) => "Caduca en ${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => "${hour}  horas";
  ...
  static String m13(size) => "Tamaño máximo de archivo: ${size} MB";

  static String m14(minute) => "${minute} minutos";

  static String m15(month) => " Hace${month} meses";

  static String m16(store) => "Más de ${store}";

  static String m17(itemCount) => "${itemCount} items";

  static String m18(price) => "Total de opciones: ${price}";

  static String m19(total) => "Cantidad: ${total}";

  static String m20(percent) => "Rebaja ${percent} %";

  static String m21(second) => "${second} segundos";
  ...
  static String m25(total) => "${total} Productos";

  static String m26(date) => "Válido hasta ${date}";

  static String m27(message) => "Advertencia: ${message}";
  ...
  static String m29(length) => "Encontramos productos de ${length}";

  static String m30(week) => "Semana ${week}";

  static String m31(year) => " Hace${year} años";

  static String m32(total) => "Ha asignado a la orden #${total}";
