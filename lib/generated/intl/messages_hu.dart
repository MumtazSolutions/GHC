...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Pénznem módosítva erre: ${currency}";

  static String m4(day) => "${day} napja";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Ends in ${timeLeft}";

  static String m7(captcha) =>
      "A megerősítéshez írja be a következőt: ${captcha} :";

  static String m8(message) => "Hiba: ${message}";

  static String m9(time) => "Lejárat ideje: ${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => "${hour} órája";
  ...
  static String m13(size) => "Maximális fájlméret: ${size} MB";

  static String m14(minute) => "${minute} perce";

  static String m15(month) => "${month} hónappal ezelőtt";

  static String m16(store) => "Továbbiak innen: ${store}";

  static String m17(itemCount) => "${itemCount} termékek";

  static String m18(price) => "Opciók összesen: ${price}";

  static String m19(total) => "Mennyiség: ${total}";

  static String m20(percent) => "${percent} % Kedvezmény";

  static String m21(second) => "${second} másodperce";
  ...
  static String m24(fieldName) => "A(z) ${fieldName} mező kitöltése kötelező";

  static String m25(total) => "${total} termék";

  static String m26(date) => "Érvényes: ${date}";

  static String m27(message) => "Figyelmeztetés: ${message}";
  ...
  static String m29(length) => "Találtunk ${length} terméket";

  static String m30(week) => " ${week}hét";

  static String m31(year) => "${year} évvel ezelőtt";

  static String m32(total) => "Hozzárendelte a (z)${total}számú megrendelést";
