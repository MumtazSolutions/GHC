...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Mena bola zmenená na ${currency}";

  static String m4(day) => " pred${day} dňami";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Končí o ${timeLeft}";

  static String m7(captcha) => "Zadajte ${captcha} na potvrdenie:";

  static String m8(message) => "Chyba: ${message}";

  static String m9(time) => "Platnosť vyprší o ${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => " pred${hour} hodinami";
  ...
  static String m13(size) => "Maximálna veľkosť súboru: ${size} MB";

  static String m14(minute) => " pred${minute} minútami";

  static String m15(month) => " pred${month} mesiacmi";

  static String m16(store) => "Viac od používateľa ${store}";

  static String m17(itemCount) => " ${itemCount} položiek";

  static String m18(price) => "Celkom: ${price}";

  static String m19(total) => "Množstvo: ${total}";

  static String m20(percent) => "Zľava ${percent}%";

  static String m21(second) => " pred ${second} sek.";

  static String m22(totalCartQuantity) =>
      "Nákupný košík, ${totalCartQuantity} položiek";

  static String m23(numberOfUnitsSold) => "Predané: ${numberOfUnitsSold}";

  static String m24(fieldName) => "Pole ${fieldName} je povinné";

  static String m25(total) => "${total} produktov";

  static String m26(date) => "Platí do ${date}";

  static String m27(message) => "Upozornenie: ${message}";

  static String m28(default_currency) =>
      "Aktuálna mena nie je dostupná pre funkciu Peňaženka. Zmeňte ju na ${default_currency}";

  static String m29(length) => "Našli sme ${length} produktov";

  static String m30(week) => " ${week}. týždeň";

  static String m31(year) => " pred${year} rokmi";

  static String m32(total) => "Pridelili ste objednávke č.${total}";
