...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "將貨幣更改為 ${currency}";

  static String m4(day) => "${day} 天前";

  static String m5(total) => "~${total} 公里";

  static String m6(timeLeft) => "以 ${timeLeft} 結尾";

  static String m7(captcha) => "輸入 ${captcha} 確認：";

  static String m8(message) => "錯誤： ${message}";

  static String m9(time) => " ${time}到期";

  static String m10(total) => ">${total} 公里";

  static String m11(hour) => "${hour} 小時前";

  static String m12(message) => "請求數據時應用出現問題，請聯繫管理員解決問題： ${message}";

  static String m13(size) => "最大文件大小： ${size} MB";

  static String m14(minute) => "${minute} 分鐘前";

  static String m15(month) => "${month} 個月前";

  static String m16(store) => " ${store}的更多內容";

  static String m17(itemCount) => "${itemCount} 項";

  static String m18(price) => "選項總數： ${price}";

  static String m19(total) => "數量： ${total}";

  static String m20(percent) => "銷售額 ${percent}%";

  static String m21(second) => "${second} 秒前";

  static String m22(totalCartQuantity) => "購物車， ${totalCartQuantity} 件商品";

  static String m23(numberOfUnitsSold) => "已售出： ${numberOfUnitsSold}";

  static String m24(fieldName) => " ${fieldName} 字段是必需的";

  static String m25(total) => "${total} 個商品";

  static String m26(date) => "有效期至 ${date}";

  static String m27(message) => "警告： ${message}";

  static String m28(default_currency) =>
      "當前選擇的貨幣不適用於電子錢包功能，請將其更改為 ${default_currency}";

  static String m29(length) => "我們找到了 ${length} 件商品";

  static String m30(week) => "第 ${week} 週";

  static String m31(year) => "${year} 年前";

  static String m32(total) => "您已指定訂單 #${total}";
