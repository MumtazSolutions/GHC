...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Đã thay đổi đơn vị tiền tệ thành ${currency}";

  static String m4(day) => "${day} days ago";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Kết thúc sau ${timeLeft}";

  static String m7(captcha) => "Nhập ${captcha} để xác nhận:";

  static String m8(message) => "Lỗi: ${message}";

  static String m9(time) => "Hết hạn sau ${time}";
  ...
  static String m13(size) => "Kích thước tệp tối đa: ${size} MB";

  static String m14(minute) => "${minute} minutes ago";

  static String m15(month) => "${month} tháng trước";

  static String m16(store) => "Thêm từ ${store}";

  static String m17(itemCount) => "${itemCount} items";

  static String m18(price) => "Tổng số tùy chọn: ${price}";

  static String m19(total) => "Số lượng: ${total}";

  static String m20(percent) => "Sale ${percent} %";
  ...
  static String m23(numberOfUnitsSold) => "Đã bán: ${numberOfUnitsSold}";

  static String m24(fieldName) => "Trường ${fieldName} là bắt buộc";

  static String m25(total) => "${total} sản phẩm";

  static String m26(date) => "Có hiệu lực cho đến ${date}";
  ...
  static String m29(length) => "Chúng tôi tìm thấy ${length} sản phẩm";

  static String m30(week) => "Tuần ${week}";

  static String m31(year) => "${year} năm trước";

  static String m32(total) => "Bạn đã chỉ định đơn đặt hàng số${total}";
