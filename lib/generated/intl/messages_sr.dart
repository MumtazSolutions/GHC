...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Promijenjena valuta u ${currency}";

  static String m4(day) => "Пре ${day} Данa";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Завршава се у${timeLeft}";

  static String m7(captcha) => "Unesite ${captcha} da potvrdite:";

  static String m8(message) => "Fehler: ${message}";

  static String m9(time) => "Истиче ${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => "Пре ${hour} Сати";
  ...
  static String m13(size) => "Maksimalna veličina datoteke: ${size} MB";

  static String m14(minute) => "Пре ${minute} Minuten";

  static String m15(month) => " Prije${month} mjeseci";

  static String m16(store) => "Više od ${store}";

  static String m17(itemCount) => "${itemCount} Ставка";

  static String m18(price) => "Укупно опција: ${price}";

  static String m19(total) => "Količina: ${total}";

  static String m20(percent) => "Распродај ${percent} %";

  static String m21(second) => "Пре ${second} Минута";

  static String m22(totalCartQuantity) =>
      "корпа, ${totalCartQuantity} предмета";

  static String m23(numberOfUnitsSold) => "продато: ${numberOfUnitsSold}";

  static String m24(fieldName) => "Polje ${fieldName} je obavezno";

  static String m25(total) => "${total} proizvoda";

  static String m26(date) => "Датум истека ${date}";

  static String m27(message) => "упозорење: ${message}";
  ...
  static String m29(length) => "Пронашли смо производе";

  static String m30(week) => " ${week}. Sedmica";

  static String m31(year) => " Prije${year} godina";

  static String m32(total) => "Dodijelili ste narudžbi br.${total}";
