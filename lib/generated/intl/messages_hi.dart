...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "मुद्रा को ${currency}में बदला गया";

  static String m4(day) => "${day} दिन पहले";

  static String m5(total) => "~${total} किमी";

  static String m6(timeLeft) => " ${timeLeft}में समाप्त होता है";

  static String m7(captcha) => "पुष्टि करने के लिए ${captcha} दर्ज करें:";

  static String m8(message) => "त्रुटि: ${message}";

  static String m9(time) => " ${time}में समाप्त हो रहा है";

  static String m10(total) => ">${total} किमी";

  static String m11(hour) => "${hour} घंटे पहले";
  ...
  static String m13(size) => "अधिकतम फ़ाइल आकार: ${size} एमबी";

  static String m14(minute) => "${minute} मिनट पहले";

  static String m15(month) => "${month} महीने पहले";

  static String m16(store) => " ${store}से अधिक";

  static String m17(itemCount) => "${itemCount} आइटम";

  static String m18(price) => "विकल्प कुल: ${price}";

  static String m19(total) => "मात्रा: ${total}";

  static String m20(percent) => "बिक्री ${percent} %";

  static String m21(second) => "${second} सेकंड पहले";

  static String m22(totalCartQuantity) =>
      "शॉपिंग कार्ट, ${totalCartQuantity} आइटम";

  static String m23(numberOfUnitsSold) => "बिक गया: ${numberOfUnitsSold}";

  static String m24(fieldName) => " ${fieldName} फ़ील्ड आवश्यक है";

  static String m25(total) => "${total} उत्पाद";

  static String m26(date) => "मान्य तिल ${date}";

  static String m27(message) => "चेतावनी: ${message}";
  ...
  static String m29(length) => "हमें ${length} उत्पाद मिले";

  static String m30(week) => "सप्ताह ${week}";

  static String m31(year) => "${year} साल पहले";

  static String m32(total) => "आपने #${total}ऑर्डर करने के लिए असाइन किया है";
