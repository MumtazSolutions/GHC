...
import 'package:fstore/frameworks/Notifications/notification_services.dart';
import 'package:fstore/models/cart/discount_coupons.dart';
import 'package:fstore/screens/wellness_weightTracker/wellness_wieght_tracker_provider.dart';
...
import 'screens/checkout/webview_provider.dart';
import 'screens/community_Forum/community_provider.dart';
import 'screens/index.dart' show ListBlogModel;
import 'screens/referral/referral_provider.dart';
import 'screens/sleep_tracker/sleep_tracker_provider.dart';
import 'screens/water_tracker/water_tracker_provider.dart';
import 'services/index.dart';
import 'widgets/overlay/custom_overlay_state.dart';

List couponList = [];
var recordNumber;
List welcomeCouponList = [];
var newCouponList;
bool isPopup = false;
...
class AppState extends State<App>
  ...
  final _progressModel = ProgressTrackingVM();
      ...
      if (user!.username != null) {
        Services().firebase.getMessagingToken().then((token) {
          try {
            ...
            NotificationServices().SaveUser(token!, user);
  ...
  Future<void> onLoaded(User? user) async {
    if (!ServerConfig().isShopify == false) {
  ...
  Future<void> onLogout(User? user) async {
    ...
    if (Services().firebase.isEnabled) {
      try {
        // log("__________________ACCECSS TOKEN:${user.}");
          ...
          return Directionality(
            ...
            child: MultiProvider(
              providers: [
                ...
                ChangeNotifierProvider(create: (_) => ProgressTrackingVM()),
                ChangeNotifierProvider(
                    create: (_) => WellnessWeightTrackerProvider()),
                ChangeNotifierProvider(create: (_) => ProgressComparisonVm()),
                ...
                ChangeNotifierProvider(
                    create: (_) => _progressModel, lazy: true),
