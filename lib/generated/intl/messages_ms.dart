...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Menukar mata wang kepada ${currency}";

  static String m4(day) => "${day} hari yang lalu";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Berakhir dalam ${timeLeft}";

  static String m7(captcha) => "Masukkan ${captcha} untuk mengesahkan:";

  static String m8(message) => "Ralat: ${message}";

  static String m9(time) => "Tamat tempoh dalam ${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => "${hour} jam yang lalu";
  ...
  static String m13(size) => "Saiz fail maksimum: ${size} MB";

  static String m14(minute) => "${minute} minit yang lalu";

  static String m15(month) => "${month} bulan yang lalu";

  static String m16(store) => "Lagi daripada ${store}";

  static String m17(itemCount) => "${itemCount} item";

  static String m18(price) => "Jumlah pilihan: ${price}";

  static String m19(total) => "Kuantiti: ${total}";

  static String m20(percent) => "Jualan ${percent}%";

  static String m21(second) => "${second} saat yang lalu";

  static String m22(totalCartQuantity) =>
      "Troli beli-belah, ${totalCartQuantity} item";

  static String m23(numberOfUnitsSold) => "Dijual: ${numberOfUnitsSold}";

  static String m24(fieldName) => "Medan ${fieldName} diperlukan";

  static String m25(total) => "${total} produk";

  static String m26(date) => "Sah sehingga ${date}";

  static String m27(message) => "Amaran: ${message}";
  ...
  static String m29(length) => "Kami menemui ${length} produk";

  static String m30(week) => "Minggu ${week}";

  static String m31(year) => "${year} tahun yang lalu";

  static String m32(total) => "Anda telah menetapkan pesanan #${total}";
