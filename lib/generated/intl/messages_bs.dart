...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(day) => "${day} dana prije";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Završava za ${timeLeft}";

  static String m8(message) => "Greška: ${message}";

  static String m9(time) => "Ističe za${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => "${hour} sati prije";
  ...
  static String m13(size) => "Maksimalna veličina fajla: ${size} MB";

  static String m14(minute) => "${minute} minuta prije";

  static String m15(month) => "${month} mjeseca prije";

  static String m17(itemCount) => "${itemCount} proizvoda";

  static String m18(price) => "Ukupno opcija: ${price}";

  static String m19(total) => "Količina: ${total}";

  static String m20(percent) => "Rasprodaja ${percent}%";

  static String m21(second) => "${second} sekundi prije";

  static String m22(totalCartQuantity) =>
      "Korpa za kupovinu, ${totalCartQuantity} proizvoda";

  static String m23(numberOfUnitsSold) => "Prodano: ${numberOfUnitsSold}";

  static String m25(total) => "${total} proizvoda";

  static String m26(date) => "Validno do ${date}";

  static String m27(message) => "Upozorenje: ${message}";
  ...
  static String m29(length) => "Pronašli smo ${length} proizvoda";

  static String m30(week) => "Sedmica ${week}";

  static String m31(year) => "${year} godine prije";

  static String m32(total) => "Dodijeljeni ste narudžbi #${total}";
