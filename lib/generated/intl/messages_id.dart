...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Mata uang diubah menjadi ${currency}";
  ...
  static String m7(captcha) => "Masukkan ${captcha} untuk mengonfirmasi:";

  static String m8(message) => "Galat: ${message}";

  static String m9(time) => "Kedaluwarsa dalam ${time}";
  ...
  static String m13(size) => "Ukuran file maksimum: ${size} MB";

  static String m14(minute) => "${minute} minutes ago";

  static String m15(month) => "${month} bulan yang lalu";

  static String m16(store) => "Lainnya dari ${store}";

  static String m17(itemCount) => "${itemCount} barang";

  static String m18(price) => "Total opsi: ${price}";

  static String m19(total) => "Jumlah: ${total}";

  static String m20(percent) => "Diskon ${percent} %";
  ...
  static String m24(fieldName) => "Bidang ${fieldName} wajib diisi";

  static String m25(total) => "${total} produk";

  static String m26(date) => "Berlaku sampai ${date}";
  ...
  static String m29(length) => "Kami menemukan produk ${length}";

  static String m30(week) => "Minggu ${week}";

  static String m31(year) => "${year} tahun lalu";

  static String m32(total) => "Anda telah menetapkan untuk memesan #${total}";
