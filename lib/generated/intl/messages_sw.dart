...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Umebadilisha sarafu kuwa ${currency}";

  static String m4(day) => " siku${day} zilizopita";

  static String m5(total) => "~${total} kilomita";

  static String m6(timeLeft) => "Inaisha baada ya ${timeLeft}";

  static String m7(captcha) => "Weka ${captcha} ili kuthibitisha:";

  static String m8(message) => "Hitilafu: ${message}";

  static String m9(time) => "Inaisha baada ya ${time}";

  static String m10(total) => "> kilomita${total} ";

  static String m11(hour) => " saa${hour} zilizopita";
  ...
  static String m13(size) => "Upeo wa ukubwa wa faili: ${size} MB";

  static String m14(minute) => " dakika${minute} zilizopita";

  static String m15(month) => " Miezi${month} iliyopita";

  static String m16(store) => "Zaidi kutoka kwa ${store}";

  static String m17(itemCount) => "${itemCount} vitu";

  static String m18(price) => "Jumla ya chaguo: ${price}";

  static String m19(total) => "Kiasi: ${total}";

  static String m20(percent) => "Uuzaji ${percent}%";

  static String m21(second) => " sekunde${second} zilizopita";

  static String m22(totalCartQuantity) =>
      "Rukwama ya ununuzi, ${totalCartQuantity} vitu";

  static String m23(numberOfUnitsSold) => "Zinauzwa: ${numberOfUnitsSold}";

  static String m24(fieldName) => "Sehemu ya ${fieldName} inahitajika";

  static String m25(total) => "${total} bidhaa";

  static String m26(date) => "Inatumika hadi ${date}";

  static String m27(message) => "Onyo: ${message}";
  ...
  static String m29(length) => "Tulipata bidhaa ${length} ";

  static String m30(week) => "Wiki ${week}";

  static String m31(year) => " miaka${year} iliyopita";

  static String m32(total) => "Umekabidhi kuagiza #${total}";
