...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Valuta modificata in ${currency}";
  ...
  static String m7(captcha) => "Inserisci ${captcha} per confermare:";

  static String m8(message) => "Errore: ${message}";

  static String m9(time) => "In scadenza tra ${time}";
  ...
  static String m13(size) => "Dimensione massima del file: ${size} MB";

  static String m14(minute) => "${minute} minutes ago";

  static String m15(month) => "${month} mesi fa";

  static String m16(store) => "Altro da ${store}";

  static String m17(itemCount) => "${itemCount} items";

  static String m18(price) => "Opzioni totali: ${price}";

  static String m19(total) => "Qtà: ${total}";

  static String m20(percent) => "${percent}% di sconto";

  static String m21(second) => "${second} seconds ago";
  ...
  static String m25(total) => "${total} Prodotti";

  static String m26(date) => "Valido fino alle ${date}";

  static String m27(message) => "Warning: ${message}";
  ...
  static String m29(length) => "Abbiamo trovato \$length prodotti";

  static String m30(week) => "Settimana ${week}";

  static String m31(year) => "${year} anni fa";

  static String m32(total) => "Hai assegnato all\'ordine #${total}";
