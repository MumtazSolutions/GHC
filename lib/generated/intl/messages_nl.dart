...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Valuta gewijzigd in ${currency}";

  static String m4(day) => "${day} dagen geleden";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Eindigt over ${timeLeft}";

  static String m7(captcha) => "Voer ${captcha} in om te bevestigen:";

  static String m8(message) => "Fout: ${message}";

  static String m9(time) => "Verloopt over ${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => "${hour} uur geleden";
  ...
  static String m13(size) => "Maximale bestandsgrootte: ${size} MB";

  static String m14(minute) => "${minute} minuten geleden";

  static String m15(month) => "${month} maanden geleden";

  static String m16(store) => "Meer van ${store}";

  static String m17(itemCount) => "${itemCount} items";

  static String m18(price) => "Opties totaal: ${price}";

  static String m19(total) => "Aantal: ${total}";

  static String m20(percent) => "Verkoop ${percent} %";

  static String m21(second) => "${second} seconden geleden";

  static String m22(totalCartQuantity) =>
      "Winkelwagen, ${totalCartQuantity} artikelen";

  static String m23(numberOfUnitsSold) => "Verkocht: ${numberOfUnitsSold}";

  static String m24(fieldName) => "Het veld ${fieldName} is verplicht";

  static String m25(total) => "${total} producten";

  static String m26(date) => "Geldig tot ${date}";

  static String m27(message) => "Waarschuwing: ${message}";
  ...
  static String m29(length) => "We hebben ${length} producten gevonden";

  static String m30(week) => "Week ${week}";

  static String m31(year) => "${year} jaar geleden";

  static String m32(total) => "Je hebt toegewezen aan bestelling #${total}";
