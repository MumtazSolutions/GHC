...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(day) => "${day} ቅድሚ ሒደት መዓልትታት";

  static String m5(total) => "~${total} ኪሎሜተር";

  static String m6(timeLeft) => " እብ ${timeLeft} ውሽጢ ከብቅዕ\'ዩ";

  static String m7(captcha) => "ነዚ ንምርግጋጽ ናብ ${captcha} ኣተዉ፦";

  static String m8(message) => "ጌጋ ፦ ${message}";

  static String m9(time) => "ኣብ ${time} ግዜ ክወድቅ\'ዩ";

  static String m10(total) => ">${total} ኪሎሜተር";

  static String m11(hour) => "${hour} ቅድሚ ሰዓታት";

  static String m12(message) =>
      "ነቲ ሓበሬታ ኽትሓትት ከላ ምስታ ኣፕሊኬሽን እተተሓሓዘ ጕዳይ ኣሎ በጃኻ ነቲ ጕዳያት ንምፍታሕ ምስ ኣመሓዳሪ ተራኸብ - ${message}";

  static String m13(size) => "ዝለዓለ መጠን ፋይል: ${size} MB";

  static String m14(minute) => "${minute} ቅድሚ ሒደት ደቓይቕ";

  static String m15(month) => "${month} ቅድሚ ኣዋርሕ";

  static String m17(itemCount) => "${itemCount} ኣቕሑት";

  static String m18(price) => "ድምር ኣማራጺታት: ${price}";

  static String m19(total) => "ብዝሒ ፦ ${total}";

  static String m20(percent) => "መሸጣ ${percent}%";

  static String m21(second) => "${second} ቅድሚ ኻልኢታት";

  static String m22(totalCartQuantity) =>
      "ዓረብያ ዕድጊ ${totalCartQuantity} ንብረት/ታት";

  static String m23(numberOfUnitsSold) => "እተሸጠ፦ ${numberOfUnitsSold}";

  static String m25(total) => "${total}  ፍርያት";

  static String m26(date) => "ቅቡል ክሳብ ${date}";

  static String m27(message) => "መጠንቀቕታ ፦ ${message}";

  static String m28(default_currency) =>
      "እቲ ኣብዚ እዋን እዚ እተመርጸ ባጤራ ነቲ ኣብ ቦርሳ ዘሎ ኣቕሓ ኣይርከብን እዩ:: በጃኻ ናብ ${default_currency} ለወጥዎ";

  static String m29(length) => "ፍርያት ${length} ረኸብና";

  static String m30(week) => "ሰሙን ${week}";

  static String m31(year) => "${year} ቅድሚ ዓመታት";

  static String m32(total) => "ትእዛዝ ክትእዝዝ መዲብካ ኣለኻ #${total}";
