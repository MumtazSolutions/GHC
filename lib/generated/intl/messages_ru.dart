...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Валюта изменена на ${currency}";

  static String m4(day) => "${day} дней назад";

  static String m5(total) => "~${total} км";

  static String m6(timeLeft) => "Ends in ${timeLeft}";

  static String m7(captcha) => "Введите ${captcha} для подтверждения:";

  static String m8(message) => "Ошибка: ${message}";

  static String m9(time) => "Срок действия истекает через ${time}";

  static String m10(total) => ">${total} км";

  static String m11(hour) => "${hour} часов назад";
  ...
  static String m13(size) => "Максимальный размер файла: ${size} МБ";

  static String m14(minute) => "${minute} минут назад";

  static String m15(month) => "${month} месяцев назад";

  static String m16(store) => "Еще от ${store}";

  static String m17(itemCount) => "${itemCount} товаров";

  static String m18(price) => "Всего вариантов: ${price}";

  static String m19(total) => "Кол-во: ${total}";

  static String m20(percent) => "Распродажа ${percent} %";

  static String m21(second) => "${second} секунд назад";
  ...
  static String m25(total) => "${total} продуктов";

  static String m26(date) => "Действительно до ${date}";

  static String m27(message) => "Предупреждение: ${message}";
  ...
  static String m29(length) => "Мы нашли товары";

  static String m30(week) => "Неделя ${week}";

  static String m31(year) => "${year} лет назад";

  static String m32(total) => "Вы назначили заказ №${total}";
