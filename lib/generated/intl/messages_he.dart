...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "המטבע שונה ל- ${currency}";

  static String m4(day) => "לפני {יום} ימים";

  static String m5(total) => "~${total} ק\"מ";

  static String m6(timeLeft) => "מסתיים בעוד ${timeLeft}";

  static String m7(captcha) => "הזן ${captcha} כדי לאשר:";

  static String m8(message) => "שגיאה: ${message}";

  static String m9(time) => "יפוג בעוד ${time}";

  static String m10(total) => ">${total} ק\"מ";

  static String m11(hour) => "לפני {שעה} שעות";

  static String m12(message) =>
      "יש בעיה באפליקציה במהלך בקשת הנתונים, אנא פנה למנהל לתיקון הבעיות: ${message}";

  static String m13(size) => "גודל קובץ מקסימלי: ${size} מגה בייט";

  static String m14(minute) => "לפני {דקה} דקות";

  static String m15(month) => " לפני${month} חודשים";

  static String m16(store) => "עוד מ- ${store}";

  static String m17(itemCount) => "${itemCount} פריטים";

  static String m18(price) => "סה\"כ אפשרויות: ${price}";

  static String m19(total) => "כמות: ${total}";

  static String m20(percent) => "הנחה ${percent}%";

  static String m21(second) => "לפני ${second} שניות";

  static String m22(totalCartQuantity) =>
      "עגלת קניות, ${totalCartQuantity} פריטים";

  static String m23(numberOfUnitsSold) => "נמכר: ${numberOfUnitsSold}";

  static String m24(fieldName) => "השדה ${fieldName} נדרש";

  static String m25(total) => "${total} מוצרים";

  static String m26(date) => "תקף עד ${date}";

  static String m27(message) => "אזהרה: ${message}";

  static String m28(default_currency) =>
      "המטבע שנבחר כרגע אינו זמין עבור תכונת הארנק, שנה אותו ל- ${default_currency}";

  static String m29(length) => "מצאנו ${length} מוצרים";

  static String m30(week) => "שבוע ${week}";

  static String m31(year) => " לפני${year} שנים";

  static String m32(total) => "הקצית להזמין מספר${total}";
