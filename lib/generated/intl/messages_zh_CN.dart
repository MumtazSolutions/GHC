...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m12(message) => "请求数据时应用出现问题，请联系管理员解决问题： ${message}";
  ...
  static String m17(itemCount) => "${itemCount} 项";

  static String m18(price) => "选项总数： ${price}";

  static String m19(total) => "数量： ${total}";

  static String m20(percent) => "销售额 ${percent}%";
  ...
  static String m25(total) => "${total} 个商品";
  ...
  static String m29(length) => "我们找到了 ${length} 件商品";

  static String m30(week) => "第 ${week} 周";
