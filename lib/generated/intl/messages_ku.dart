...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(day) => "${day} ڕۆژ پێش ئێستا";

  static String m6(timeLeft) => "${timeLeft} تەواو دەبێت";

  static String m8(message) => "هەڵە: ${message}";

  static String m9(time) => "بەسەردەچێت لە ${time}";

  static String m11(hour) => "${hour} کاتژمێر پێش ئێستا";
  ...
  static String m14(minute) => "${minute} خولەك پێش ئێستا";

  static String m17(itemCount) => "${itemCount} ئایتم";

  static String m18(price) => "کۆى گشتى هەڵبژاردنەکان: ${price}";

  static String m20(percent) => "داشکاندن ${percent} %";

  static String m21(second) => "${second} چرکە پێش ئێستا";
  ...
  static String m25(total) => "${total} بەرهەمەکان";

  static String m26(date) => "گونجاوە تا ${date}";

  static String m27(message) => "ئاگاداری: ${message}";

  static String m29(length) => "${length} بەرهەم دۆزرایەوە";
