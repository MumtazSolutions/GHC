...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "நாணயம் ${currency}ஆக மாற்றப்பட்டது";

  static String m4(day) => "நாட்களுக்கு முன்னர்";

  static String m5(total) => "~${total} கி.மீ";

  static String m6(timeLeft) => "முடிவடைய";

  static String m7(captcha) => "உறுதிப்படுத்த ${captcha} ஐ உள்ளிடவும்:";

  static String m8(message) => "error";

  static String m9(time) => "காலாவதியாகிவிட";

  static String m10(total) => ">${total} கி.மீ";

  static String m11(hour) => "மணித்தியாலத்திற்கு முன்னர்";

  static String m12(message) =>
      "இந்த ஆப்பில் தகவலைப் பெறுவது சிரமமாக உள்ளது. இதைத் தீர்க்க அட்மினை அணுகவும். ";

  static String m13(size) => "அதிகபட்ச கோப்பு அளவு :";

  static String m14(minute) => "நிமிடத்திற்கு முன்னர்";

  static String m15(month) => "${month} மாதங்களுக்கு முன்பு";

  static String m16(store) => " ${store}இலிருந்து மேலும்";

  static String m17(itemCount) => " பொருட்கள்";

  static String m18(price) => "மொத்த தெரிவுகள்: ";

  static String m19(total) => "அளவு: ${total}";

  static String m20(percent) => "தள்ளுபடி ";

  static String m21(second) => "விநாடிகளுக்கு முன்னர்";

  static String m22(totalCartQuantity) => "ஷாப்பிங் கார்ட் பொருட்கள்";

  static String m23(numberOfUnitsSold) => "விற்பனையானவை";

  static String m24(fieldName) => " ${fieldName} புலம் தேவை";

  static String m25(total) => " மொத்த பொருட்கள்";

  static String m26(date) => "செல்லுபடியாகும் திகதி";

  static String m27(message) => "எச்சரிக்கை";
  ...
  static String m29(length) => "மேலதிகப் பொருட்கள்";

  static String m30(week) => "வாரம் ${week}";

  static String m31(year) => "${year} ஆண்டுகளுக்கு முன்பு";

  static String m32(total) =>
