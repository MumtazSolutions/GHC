...
import '../screens/community_Forum/community_home.dart';
import '../screens/community_Forum/no_user_screen.dart';
import '../screens/customer_support/customer_support_screen.dart';
...
import '../screens/progress/progress_categories.dart';
...
import '../widgets/progress_stepper/invalidate_screen.dart';
...
class Routes {
  ...
  static Route getRouteGenerate(RouteSettings settings) {
    ...
    switch (routingData.route) {
      ...
      case RouteList.community:
        final data = settings.arguments;
        if (data is TabBarMenuConfig) {
          return _buildRoute(
            settings,
            (context) => Consumer<UserModel>(
              builder: ((context, value, child) {
                if (value.user?.loggedIn == null ||
      ...
      case RouteList.support:
        return _buildRoute(
            settings, (context) => const CustomerSupportScreen());
      case RouteList.cart:
      ...
      case RouteList.subCategories:
        ...
        return _errorRoute();
      case RouteList.progress:
        final data = settings.arguments;
        if (data is TabBarMenuConfig) {
          return _buildRoute(
            settings,
            (context) => const ProgressCategories(),
          );
        }
        return _errorRoute(data.toString());
      ...
      case RouteList.inValidDateScreen:
        if (ServerConfig().isWooType) {
          return _buildRoute(
              settings, (context) => InvalidProgressDateScreen());
        }
        return _buildRoute(settings, (context) => InvalidProgressDateScreen());
