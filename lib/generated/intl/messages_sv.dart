...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Ändrade valuta till ${currency}";

  static String m4(day) => "${day} dagar sedan";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Slutar om ${timeLeft}";

  static String m7(captcha) => "Ange ${captcha} för att bekräfta:";

  static String m8(message) => "Fel: ${message}";

  static String m9(time) => "Går ut om ${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => "${hour} timmar sedan";
  ...
  static String m13(size) => "Maximal filstorlek: ${size} MB";

  static String m14(minute) => " För${minute} minuter sedan";

  static String m15(month) => "${month} månader sedan";

  static String m16(store) => "Mer från ${store}";

  static String m17(itemCount) => "${itemCount} objekt";

  static String m18(price) => "Totalt antal alternativ: ${price}";

  static String m19(total) => "Antal: ${total}";

  static String m20(percent) => "Försäljning ${percent}%";

  static String m21(second) => " För${second} sekunder sedan";

  static String m22(totalCartQuantity) =>
      "Kundvagn, ${totalCartQuantity} artiklar";

  static String m23(numberOfUnitsSold) => "Såld: ${numberOfUnitsSold}";

  static String m24(fieldName) => "Fältet ${fieldName} är obligatoriskt";

  static String m25(total) => "${total} produkter";

  static String m26(date) => "Gäller till ${date}";

  static String m27(message) => "Varning: ${message}";
  ...
  static String m29(length) => "Vi hittade ${length} produkter";

  static String m30(week) => "Vecka ${week}";

  static String m31(year) => " För${year} år sedan";

  static String m32(total) => "Du har tilldelat order nr${total}";
