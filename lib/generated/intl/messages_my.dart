...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "ငွေကြေးကို ${currency}သို့ ပြောင်းခဲ့သည်";

  static String m4(day) => "${day} days ago";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "ပြီးဆုံးရန် ${timeLeft}";

  static String m7(captcha) => "အတည်ပြုရန် ${captcha} ကိုထည့်ပါ-";
  ...
  static String m13(size) => "အကြီးဆုံးလက်ခံနိုင်သည့်ဖိုင်ဆိုဒ်: ${size} MB";

  static String m14(minute) => "${minute} minutes ago";

  static String m15(month) => "${month} လအကြာက";

  static String m16(store) => " ${store}မှ နောက်ထပ်";

  static String m17(itemCount) => "${itemCount} items";

  static String m18(price) => "Options total: ${price}";

  static String m19(total) => "Qty: ${total}";
  ...
  static String m24(fieldName) => " ${fieldName} အကွက် လိုအပ်သည်။";

  static String m25(total) => "${total} products";

  static String m26(date) => "Valid til ${date}";

  static String m27(message) => "သတိပေးချက်: ${message}";
  ...
  static String m29(length) => "We found ${length} products";

  static String m30(week) => "Week ${week}";

  static String m31(year) => "${year} နှစ်အကြာက";

  static String m32(total) => "You have assigned to order #${total}";
