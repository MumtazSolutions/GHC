...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Měna změněna na ${currency}";

  static String m4(day) => " Před${day} dny";

  static String m5(total) => "~${total} km";

  static String m6(timeLeft) => "Končí za ${timeLeft}";

  static String m7(captcha) => "Zadejte ${captcha} pro potvrzení:";

  static String m8(message) => "Chyba: ${message}";

  static String m9(time) => "Končí za ${time}";

  static String m10(total) => ">${total} km";

  static String m11(hour) => " Před${hour} hodinami";
  ...
  static String m13(size) => "Maximální velikost souboru: ${size} MB";

  static String m14(minute) => " Před${minute} minutami";

  static String m15(month) => " Před${month} měsíci";

  static String m16(store) => "Více od uživatele ${store}";

  static String m17(itemCount) => " Položky:${itemCount} ";

  static String m18(price) => "Celkem možností: ${price}";

  static String m19(total) => "Množství: ${total}";

  static String m20(percent) => "Výprodej ${percent}%";

  static String m21(second) => " Před${second} s";

  static String m22(totalCartQuantity) =>
      "Nákupní košík, položky: ${totalCartQuantity} ";

  static String m23(numberOfUnitsSold) => "Prodáno: ${numberOfUnitsSold}";

  static String m24(fieldName) => "Pole ${fieldName} je povinné";

  static String m25(total) => "${total} produktů";

  static String m26(date) => "Platí do ${date}";

  static String m27(message) => "Upozornění: ${message}";
  ...
  static String m29(length) => "Našli jsme ${length} produktů";

  static String m30(week) => "Týden ${week}";

  static String m31(year) => " Před${year} lety";

  static String m32(total) => "Přiřadili jste k objednávce č.${total}";
