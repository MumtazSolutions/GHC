...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "Змінено валюту на ${currency}";

  static String m4(day) => "${day} днів тому";

  static String m5(total) => "~${total} км";

  static String m6(timeLeft) => "Закінчується через ${timeLeft}";

  static String m7(captcha) => "Введіть ${captcha} , щоб підтвердити:";

  static String m8(message) => "Помилка: ${message}";

  static String m9(time) => "Термін дії закінчується через ${time}";

  static String m10(total) => ">${total} км";

  static String m11(hour) => "${hour} годин тому";
  ...
  static String m13(size) => "Максимальний розмір файлу: ${size} МБ";

  static String m14(minute) => "${minute} хвилин тому";

  static String m15(month) => "${month} місяців тому";

  static String m16(store) => "Більше від ${store}";

  static String m17(itemCount) => "${itemCount} елементів";

  static String m18(price) => "Всього варіантів: ${price}";

  static String m19(total) => "Кількість: ${total}";

  static String m20(percent) => "Продаж ${percent}%";

  static String m21(second) => "${second} секунд тому";

  static String m22(totalCartQuantity) =>
      "Кошик, товарів: ${totalCartQuantity} ";

  static String m23(numberOfUnitsSold) => "Продано: ${numberOfUnitsSold}";

  static String m24(fieldName) => "Поле ${fieldName} є обов’язковим";

  static String m25(total) => "${total} продуктів";

  static String m26(date) => "Діє до ${date}";

  static String m27(message) => "Попередження: ${message}";

  static String m28(default_currency) =>
      "Вибрана валюта зараз недоступна для функції Wallet. Змініть її на ${default_currency}";

  static String m29(length) => "Ми знайшли ${length} продуктів";

  static String m30(week) => "Тиждень ${week}";

  static String m31(year) => "${year} років тому";

  static String m32(total) => "Ви призначили замовлення №${total}";
