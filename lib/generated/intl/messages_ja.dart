...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "通貨を ${currency}に変更しました";
  ...
  static String m7(captcha) => " ${captcha} を入力して確認します。";

  static String m8(message) => "Error: ${message}";

  static String m9(time) => " ${time}で期限切れ";
  ...
  static String m13(size) => "最大ファイルサイズ： ${size} MB";

  static String m14(minute) => "${minute} minutes ago";

  static String m15(month) => "${month} か月前";

  static String m16(store) => " ${store}からの詳細";

  static String m17(itemCount) => "${itemCount} items";

  static String m18(price) => "オプションの合計： ${price}";

  static String m19(total) => "数量： ${total}";

  static String m20(percent) => "セール${percent}％";
  ...
  static String m24(fieldName) => " ${fieldName} フィールドは必須です";

  static String m25(total) => "${total} 製品";

  static String m26(date) => " ${date}まで有効";
  ...
  static String m29(length) => "${length} 個の商品が見つかりました";

  static String m30(week) => "週 ${week}";

  static String m31(year) => "${year} 年前";

  static String m32(total) => "注文番号${total}に割り当てました";
