...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currency) => "将货币更改为 ${currency}";

  static String m4(day) => "${day} 天前";

  static String m5(total) => "~${total} 公里";

  static String m6(timeLeft) => "以 ${timeLeft}结尾";

  static String m7(captcha) => "输入 ${captcha} 确认：";

  static String m8(message) => "Error: ${message}";

  static String m9(time) => "在 ${time}期满";

  static String m10(total) => ">${total} 公里";

  static String m11(hour) => "${hour} 小时前";

  static String m12(message) => "应用程序在请求数据期间出现问题，请联系管理员解决问题： ${message}";

  static String m13(size) => "档案大小上限： ${size} MB";

  static String m14(minute) => "${minute} 分钟钱";

  static String m15(month) => "${month} 个月前";

  static String m16(store) => " ${store}的更多内容";

  static String m17(itemCount) => "${itemCount} 件商品";

  static String m18(price) => "选项总数： ${price}";

  static String m19(total) => "数量： ${total}";

  static String m20(percent) => "出售${percent}%";

  static String m21(second) => "${second} 秒前";

  static String m22(totalCartQuantity) => "购物车, ${totalCartQuantity} 件商品";

  static String m23(numberOfUnitsSold) => "已售出： ${numberOfUnitsSold}";

  static String m24(fieldName) => " ${fieldName} 字段是必需的";

  static String m25(total) => "${total} 个产品";
  ...
  static String m29(length) => "我们找到 ${length} 个产品";

  static String m30(week) => "周 ${week}";

  static String m31(year) => "${year} 年前";

  static String m32(total) => "您已指定订单 #${total}";
