  ...
  Future<void> afterFirstLayout(BuildContext context) async {
    ...
    if (userModel.user != null &&
      ...
      await Services().widget.syncCartFromWebsite(
          '${userModel.user?.cookie ?? ''}', null, context);
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<AppModel>(
      builder: (context, value, child) {
        ...
        bool isStickyHeader = value.appConfig?.settings != null
            ? (value.appConfig?.settings.stickyHeader ?? false)
            : false;
          ...
          body: Stack(
            children: <Widget>[
              ...
              HomeLayout(
                ...
                isShowAppbar: value.appConfig?.background?.layout == 'logo',
